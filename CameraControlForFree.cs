...
public class CameraControlForFree : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(!GameObject.Find("sphere screen").GetComponent<FreeViewer>().annotationMode)
        {
    ...
    void Turning()
    {
        if (!(Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D)) && !GameObject.Find("sphere screen").GetComponent<FreeViewer>().annotationMode)
        {
