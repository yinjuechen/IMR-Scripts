...
public class CameraControlForAnno : MonoBehaviour
{
    ...
    void Update()
    {
        //if (GameObject.Find("sphere screen").GetComponent<FrameViFreeViewerewer>().reviewMode || GameObject.Find("sphere screen").GetComponent<FrameViewer>().playNavigationMode)
        if (!GameObject.Find("sphere screen").GetComponent<AnnoViewer>().annotationMode)
        {
    ...
    void Turning()
    {
        if (!(Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D)) && !GameObject.Find("sphere screen").GetComponent<AnnoViewer>().annotationMode)
        {
